<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="ConsultarFormClienteWillis.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.ConsultarFormClienteWillis" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCCFC" TagName="ConsultarFormCliente1" Src="~/UserControls/Sarlaft/ConsultarFormClienteWillis.ascx" %>
