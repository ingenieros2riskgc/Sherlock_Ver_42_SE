...
<style type="text/css">
    ...
    /*Base*/
    input[type='button'] {
        background-image : url("/Imagenes/Icons/switch-on-icon.png")!important;
        width:27px;
    ...
    /*Cambiar*/
    input.activar {
        background-image : url("/Imagenes/Icons/switch-off-icon.png")!important;
        width:27px;
        background-repeat: no-repeat, repeat;
        background-position: center;
        cursor:pointer;
    ...
    input.inactivar {
     ...
     img#ctl00_ContentPlaceHolder5_Controles_GridView1_ctl02_LinkButton12{
        background-image : url("/Imagenes/Icons/switch-off-icon.png")!important;
        width:27px;
        background-repeat: no-repeat, repeat;
        background-position: center;
...
<%--Modal confirmacion para activar o inactivar control - Yoendy--%>
 <asp:ModalPopupExtender ID="mpeMsgBox1" runat="server" TargetControlID="btndummy1"
        ...
        <asp:Panel ID="pnlMsgBox1" runat="server" Width="400px" Style="display: none;" BorderColor="#575757"
            ...
            <table width="100%">
                ...
                <tr align="right">
                    <td align="right" colspan="2">
                        <asp:Button ID="btnAceptar1" runat="server" Font-Names="Calibri" Font-Size="Small" OnClick="btnAceptar1_Click" Text="Ok" ValidationGroup="Justificacion" />
                            ...
                            <td>
                                <table>
                                    <tr align="center">
                                        ...
                                        <td>
                                            <asp:ImageButton ID="ImageButton15" CssClass="ImageButton15" runat="server" ImageUrl="~/Imagenes/Icons/cancel.png"
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image"  HeaderText="Editar" ImageUrl="~/Imagenes/Icons/edit.png" Text="Editar" CommandName="Modificar" />                                        
                                        <%--REQ-03 Gestionar controles --Yoendy--%>
                                    ...
                                    <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/switch-off-icon.png" Text="Eliminar"
                                    CommandName="Activar" Visible="false" />
                                    </Columns>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td colspan="3" bgcolor="#EEEEEE">
                                            <asp:TextBox ID="TextBox3" runat="server" TextMode="MultiLine" Width="584px" Height="50px"
                                                Font-Names="Calibri" Font-Size="Small" MaxLength="500"></asp:TextBox>
