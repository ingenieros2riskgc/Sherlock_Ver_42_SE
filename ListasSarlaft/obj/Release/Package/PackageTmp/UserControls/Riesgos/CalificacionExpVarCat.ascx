<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalificacionExpVarCat.ascx.cs" Inherits="ListasSarlaft.UserControls.Riesgos.CalificacionExpVarCat" %>
    ...
    <table width="100%">
        ...
        <tr align="right">
            <td align="right" colspan="2">
                <asp:Button ID="Guardar" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Actualizar" OnClick="Guardar_Click" />
...
<%--Modal confirmacion para activar o inactivar variables - Yoendy--%>
 <asp:ModalPopupExtender ID="mpeMsgBox1" runat="server" TargetControlID="btndummy1"
        ...
        <asp:Panel ID="pnlMsgBox1" runat="server" Width="400px" Style="display: none;" BorderColor="#575757"
            ...
            <table width="100%">
                ...
                <tr align="right">
                    <td align="right" colspan="2">
                        <asp:Button ID="btnAceptar" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Ok" ValidationGroup="Justificacion" onclick="btnAceptar_Click"/>
                ...
                <tr align="center" bgcolor="#333399">
                    <td>
                        <asp:Label ID="Label140" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                            ForeColor="White" Text="Variables - Calificación Cuantitativa - Frecuencia"></asp:Label>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GvVariables" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            DataKeyNames="IdVariable, NombreVariable, Ponderacion" OnRowCommand="GvVariables_RowCommand" OnPageIndexChanging="GvVariables_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Ponderación" DataField="Ponderacion" />                                
