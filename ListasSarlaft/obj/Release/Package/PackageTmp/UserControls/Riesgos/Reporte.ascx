...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="btnExportarRCvsREvsPA"></asp:PostBackTrigger>
    </Triggers>
    <ContentTemplate>
        <table align="center" bgcolor="#EEEEEE">
                        ...
                        <tr align="left">
                            ...
                            <td bgcolor="#EEEEEE">
                                <asp:DropDownList ID="DropDownList1" runat="server" Width="200px" Font-Names="Calibri"
                                    ...
                                    <asp:ListItem Value="11">Riesgos vs Eventos vs Planes de Acción</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr align="left">
                            ...
                            <td bgcolor="#EEEEEE">
                                ...
                                <asp:CalendarExtender ID="TxtFechaIni_CalendarExtender" runat="server" Format="yyyy-MM-dd"
                                    Enabled="True" TargetControlID="TxtFechaIni"></asp:CalendarExtender>
                            </td>
                        </tr>
                        <tr align="left">
                            <td bgcolor="#BBBBBB">
                            ...
                            <td bgcolor="#EEEEEE">
                                ...
                                <asp:CalendarExtender ID="txtFechaFin_CalendarExtender" runat="server" Format="yyyy-MM-dd"
                                    Enabled="True" TargetControlID="TxtFechaFin"></asp:CalendarExtender>
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <td>
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Nombre Area" DataField="NombreArea" />
                                        <asp:BoundField HeaderText="Fecha Recuperación" DataField="FechaRecuperacion" />
                                        <asp:BoundField HeaderText="Cuantía Recuperación" DataField="CuantiaRecup" />
                                        <asp:BoundField HeaderText="Otras Cuantías" DataField="CuantiaOtraRecup" />
                                        <asp:BoundField HeaderText="Cuantía Neta" DataField="CuantiaNeta" />
                                    </Columns>
                                    <EditRowStyle BackColor="#999999" />
                                    <FooterStyle BackColor="White" Font-Bold="True" ForeColor="White" />
                                    <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            ...
            <!--Cesar-->
            <tr align="center" id="ReporteRiesgosEventosPlanesAccion" runat="server" visible="false">
                <td>
                    <table>
                         <tr align="left">
                            <td>
                              <%--  <asp:ImageButton ID="btnExportarRCvsREvsPA" runat="server" ImageUrl="~/Imagenes/Icons/excel.png"  ToolTip="Exportar" 
                                    OnClick="btnExportarRCvsREvsPA_Click" />--%>

                                <asp:Button ID="btnExportarRCvsREvsPA" runat="server" Text="Exportar" ToolTip="Exportar" Font-Names="Calibri"
                                    Font-Size="Small" OnClick="btnExportarRCvsREvsPA_Click" />
                            </td>
                        </tr>
                        <tr align="center">
                            <td>
                                <asp:GridView ID="gvRCvsREvsPA" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ForeColor="#333333" GridLines="Vertical" ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader"
                                    BorderStyle="Solid" HorizontalAlign="Center" Font-Names="Calibri" Font-Size="Small"
                                    AllowPaging="True" OnPageIndexChanging="gvRCvsREvsPA_PageIndexChanging">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField HeaderText="Codigo Riesgo" DataField="CodigoRiesgo" />
                                        <asp:BoundField HeaderText="Riesgo" DataField="NombreRiesgo" />
    ...
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="btnExportarRCvsRE" />
        <asp:PostBackTrigger ControlID="btnExportarRCvsREvsPA" />
    </Triggers>
</asp:UpdatePanel>
