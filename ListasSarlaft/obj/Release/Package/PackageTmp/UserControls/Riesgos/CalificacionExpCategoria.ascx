<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalificacionExpCategoria.ascx.cs" Inherits="ListasSarlaft.UserControls.Riesgos.CalificacionExpCategoria" %>
                ...
                <tr align="center" bgcolor="#333399">
                    <td>
                        <asp:Label ID="Label140" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                            ForeColor="White" Text="Categorías - Calificación Experta"></asp:Label>
                    </td>
                </tr>
            </table>
