...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlActividad" runat="server" CssClass="popup" Width="400px" Height="500px" Style="display: none" ScrollBars="Auto">
                ...
                <tr align="center">
                    <td>
                        <asp:GridView ID="GridView2" runat="server" Font-Names="Calibri" CellPadding="4"
                            ...
                            BorderStyle="Solid" DataKeyNames="intId, strDescripcion" AllowPaging="False" AllowSorting="True"
