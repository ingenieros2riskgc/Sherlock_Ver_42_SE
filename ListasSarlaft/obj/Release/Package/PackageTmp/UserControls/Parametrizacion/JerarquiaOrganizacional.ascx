    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="Panel2" runat="server">
            ...
            <table align="center">
                                        ...
                                        <table width="100%" class="tabla">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblNodoNuevoPadre" runat="server" Width="360px" CssClass="Apariencia" Visible="False"></asp:Label>
                                                    <asp:Label ID="lblIdNuevoPadre" runat="server" Text="Label" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblselNewJer" runat="server" Text="Cambiar Jerarquia:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:ImageButton ID="imgSelNewJer" runat="server" ImageUrl="~/Imagenes/Icons/edit-find-replace.png"
                                                        OnClick="imgSelNewJer_Click" ToolTip="Nueva Jerarquia"  />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                ...
                <tr bgcolor="#EEEEEE">
                    <td>
                        <asp:Panel ID="pnlNewJer" runat="server" Visible="false">
                            <table width="100%" align="center">
                                <tr align="center" bgcolor="#333399">
                                            <td>
                                                <asp:Label ID="lblTitulo" runat="server" ForeColor="White" Text="Cambio de Jerarquía Organizacional"
                                                    CssClass="AparienciaTitulo" Font-Bold="false"></asp:Label>
                                            </td>
                                        </tr>
                                <tr>
                                    <td>
                                        <table width="100%" border="1">
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblSelJer" runat="server" Text="Jerarquía Organizacional:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <%--<asp:DropDownList ID="ddlJerarquia" runat="server" CssClass="Apariencia" Width="200px"
                                                        DataSourceID="SqlDataSource1" DataTextField="Nombrehijo" DataValueField="IdHijo"
                                                        AutoPostBack="true" OnSelectedIndexChanged="ddlJerarquia_SelectedIndexChanged"
                                                        AppendDataBoundItems="true">
                                                        <asp:ListItem Text="" Value="-1" Selected="True"></asp:ListItem>
                                                    </asp:DropDownList>--%>
                                                    <asp:TreeView ID="tvNewJerarquia" ExpandDepth="6" runat="server" Font-Names="Calibri"
                                                                    Font-Bold="False" Font-Size="Small" LineImagesFolder="~/TreeLineImages" ForeColor="Black"
                                                                    ShowLines="True" OnSelectedNodeChanged="tvNewJerarquia_SelectedNodeChanged" Style="overflow: auto"
                                                                    Width="70%" BackColor="#FFFFFF" HoverNodeStyle-BorderStyle="Ridge" SelectedNodeStyle-BorderStyle="None">
                                                                    <SelectedNodeStyle BackColor="#FFFF99" BorderColor="#FFCC99" BorderStyle="Ridge" />
                                                                </asp:TreeView>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblNombreResAnt" runat="server" Text="Nombre Responsable:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtNombreResAnt" runat="server" Width="360px" CssClass="Apariencia"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvNombreResAnt" runat="server" ControlToValidate="txtNombreResAnt"
                                                        ForeColor="Red" ValidationGroup="validarCamposJer">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblEmailANt" runat="server" Text="Correo Electrónico Responsable:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtEmailAnt" runat="server" Width="360px" CssClass="Apariencia"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvEmailAnt" runat="server" ControlToValidate="txtEmailAnt"
                                                        ForeColor="Red" ValidationGroup="validarCamposJer">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblCargoResAnt" runat="server" Text="Cargo Responsable:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtCargoResAnt" runat="server" Width="360px" CssClass="Apariencia"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvCargoAnt" runat="server" ControlToValidate="txtCargoResAnt"
                                                        ForeColor="Red" ValidationGroup="validarCamposJer">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label9" runat="server" Text="Nombre Responsable:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtNombreResNew" runat="server" Width="360px" CssClass="Apariencia"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvNombreResNew" runat="server" ControlToValidate="txtNombreResNew"
                                                        ForeColor="Red" ValidationGroup="validarCamposJer">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblEmailNew" runat="server" Text="Correo Electrónico Responsable:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtEmailNew" runat="server" Width="360px" CssClass="Apariencia"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td align="left" bgcolor="#BBBBBB">
                                                    <asp:Label ID="lblCargoResNew" runat="server" Text="Cargo Responsable:" CssClass="Apariencia"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtCargoResNew" runat="server" Width="360px" CssClass="Apariencia"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvCargoResNew" runat="server" ControlToValidate="txtCargoResNew"
                                                        ForeColor="Red" ValidationGroup="validarCamposJer">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="center">
                                                            <asp:ImageButton ID="imgChange" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                        OnClick="imgChange_Click" ToolTip="Guardar" ValidationGroup="validarCamposJer" />
                                                            <asp:ImageButton ID="imgCancelNewJer" runat="server" ImageUrl="~/Imagenes/Icons/cancel.png"
                                                        ToolTip="Cancelar" OnClick="imgCancelNewJer_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
