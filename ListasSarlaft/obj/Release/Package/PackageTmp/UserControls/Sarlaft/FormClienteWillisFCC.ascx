<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormClienteWillisFCC.ascx.cs"
    Inherits="ListasSarlaft.UserControls.FormClienteWillisFCC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" style="background-color: #EFEEDE">
    <ContentTemplate>
        ...
        <table align="center">
            <tr>
                <td>
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Imagenes/Icons/TituloWillis.png" />
                </td>
            </tr>
        </table>
            </div>
        ...
        <table id="IframeFCC" runat="server" align="center" visible="false" width="100%">
            <tr runat="server" id="trIframe" align="center">
                <td align="center">
                    <iframe runat="server" id="IFcategorias" style="width: 100%; height: 1000px; border:none;"></iframe>
