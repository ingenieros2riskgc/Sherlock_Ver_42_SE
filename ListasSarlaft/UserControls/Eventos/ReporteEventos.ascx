                            ...
                            <td>
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NombreImpactoCualitativo" HeaderText="Impacto Cualitativo" />
                                        <asp:BoundField DataField="CodigosEventosAsociados" HeaderText="Eventos Asociados" />
                                       <%-- <asp:BoundField DataField="Area" HeaderText="Área" />--%>
                                        <asp:BoundField HeaderText="Fecha Registro" DataField="Fecha Registro" />
                                        <asp:BoundField DataField="FechaRecuperacion" HeaderText="Fecha Recuperación" />
                                        <asp:BoundField DataField="CuantiaRecup" HeaderText="Cuantía Recuperación" />
                                        <asp:BoundField DataField="CuantiaOtraRecup" HeaderText="Cuantía Otras Recuperaciones" />
                                        <asp:BoundField DataField="CuantiaNeta" HeaderText="Cuantía Neta" />
                                    </Columns>
                                    <EditRowStyle BackColor="#999999" />
                                    <FooterStyle BackColor="White" Font-Bold="True" ForeColor="White" />
                                    <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
