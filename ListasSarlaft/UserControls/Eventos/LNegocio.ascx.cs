...
{
    public partial class LNegocio : System.Web.UI.UserControl
    {
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdLineaNegocio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdLineaNegocio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
