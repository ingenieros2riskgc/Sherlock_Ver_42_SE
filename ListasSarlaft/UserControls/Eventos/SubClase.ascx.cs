...
{
    public partial class SubClase : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                ...
                ddlClase.SelectedValue = GridView1.SelectedDataKey[1].ToString().Trim();
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdSubClase"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdSubClase"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["IdClase"].DefaultValue = ddlClase.SelectedValue;
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataSource1.InsertParameters["IdClase"].DefaultValue = ddlClase.SelectedValue;
        ...
        {
            ddlClase.Items.Insert(0, new ListItem("", "0")); // Inserta el Item con texto Vacio        
        }
        #endregion
