...
{
    public partial class Clases : System.Web.UI.UserControl
    {
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdClase"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdClase"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
