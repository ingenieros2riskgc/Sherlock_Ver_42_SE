...
{
    public partial class SubServicios : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                ...
                ddlServicio.SelectedValue = GridView1.SelectedDataKey[1].ToString().Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                txtId.Text = "";
                txtId.Enabled = false;
                ddlServicio.SelectedValue = null;
                ddlServicio.Focus();
                txtNombre.Text = "";
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdSubServicio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                SqlDataSource1.UpdateParameters["IdSubServicio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                SqlDataSource1.UpdateParameters["IdServicio"].DefaultValue = ddlServicio.SelectedValue;
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataSource1.InsertParameters["IdServicio"].DefaultValue = ddlServicio.SelectedValue;
        ...
        {
            ddlServicio.Items.Insert(0, new ListItem("", "0")); // Inserta el Item con texto Vacio        
        }
        #endregion
        ...
        protected Boolean VerificarCampos()
        {
            ...
            {
                err = false;
                omb.ShowMessage("Debe seleccionar el servicio.", 2, "Atención");
                ddlServicio.Focus();
            }
