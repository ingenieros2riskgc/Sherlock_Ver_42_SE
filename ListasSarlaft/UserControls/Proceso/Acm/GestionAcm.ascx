                                        ...
                                        <tr>
                                            <td style="width: 100%">
                                                <asp:GridView ID="gvAcm" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    CssClass="Apariencia" Font-Bold="False" Width="100%" OnRowCommand="GvAcm_RowCommand">
                                                    <Columns>
                            ...
                            <td colspan="3">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDescNoConformidad" runat="server" Width="300px" CssClass="Apariencia" Rows="3" TextMode="MultiLine"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCausasRaiz" runat="server" Width="300px" CssClass="Apariencia" Rows="3" TextMode="MultiLine"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="gvActividades" runat="server" ShowFooter="True" AutoGenerateColumns="False" Width="100%" >
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Estado">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblEstadoGv" runat="server" Width="99%" CssClass="text-center" Font-Size="Smaller" Font-Bold="false" ForeColor="GrayText"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
