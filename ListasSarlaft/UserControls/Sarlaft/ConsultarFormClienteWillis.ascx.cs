...
{
    public partial class ConsultarFormClienteWillis : System.Web.UI.UserControl
    {
        ...
        private void cargarInfoFCC_Validar(Int32 IdRegistro,string TipoPersona)
        {
            try
            {
                ...
                if (TipoPersona == "1")
                    URL_FCC += "personanatural/ValidatePN?IdFormulario=" + IdRegistro + "&IdEstado=1&nasesor=" + Session["NombreUsuario"].ToString() + " / Asistente Sarlaft&idRol="+ Session["IdRol"].ToString();//&UserWP=" + ConfigurationManager.AppSettings["UsuarioWillis"].ToString();
                else
                    URL_FCC += "PersonaJuridica/ValidatePJ?IdFormulario=" + IdRegistro + "&IdEstado=1&nasesor=" + Session["NombreUsuario"].ToString() + " / Asistente Sarlaft&idRol=" + Session["IdRol"].ToString();//&UserWP=" + ConfigurationManager.AppSettings["UsuarioWillis"].ToString();
            ...
            {
                Mensaje("Error al cargar información FCC  -->> " + ex.Message);
            }
        ...
        private void cargarInfoFCC_Imprimir(Int32 IdRegistro, string TipoPersona)
        {
            try
            {
                ...
                iframeFCC_Validar.Attributes.Add("src", URL_FCC_Print);
            }
            catch (Exception ex)
            {
                Mensaje("Error al imprimir PDF -->> " + ex.Message);
            }
        }
