<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsultarFormClienteWillis.ascx.cs"
    Inherits="ListasSarlaft.UserControls.ConsultarFormClienteWillis" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sherlock_TestConnectionString %>" SelectCommand="SP_VerEstados" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table align="center" bgcolor="#EEEEEE">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label18" runat="server" ForeColor="White" Text="Consultar Formulario Conocimiento Cliente"
            ...
            <tr align="center">
                <td>
                    <table>
                        <tr>
                            <td >
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label19" runat="server" Text="Tipo de persona" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="DDLTipoPersona" runat="server" DataSourceID="SqlDataSourceTipoPersona" DataTextField="Descripcion" DataValueField="IdTipoPersona" Font-Names="calibri" Font-Size="Small" OnSelectedIndexChanged="DDLTipoPersona_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                            <asp:SqlDataSource ID="SqlDataSourceTipoPersona" runat="server" ConnectionString="<%$ ConnectionStrings:Sherlock_TestConnectionString %>" 
                                                SelectCommand="select * from TipoPersona"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table id="TblFiltroNatural" runat="server" visible="false" >
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label21" runat="server" Text="Primer Apellido" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label22" runat="server" Text="Segundo Apellido" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label23" runat="server" Text="Nombre" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label31" runat="server" Text="Número de Identificación" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TxBxPApellido" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TxBxSApellido" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TxBxNombre" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TxBxNumeiden" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table id="TblFiltroJuridica" runat="server" visible="false" >
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label32" runat="server" Text="Razón Social" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label34" runat="server" Text="Nit" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TxBxRazonSocial" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TxBxNit" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table id="TblFecha" runat="server" >
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label35" runat="server" Text="Fecha Desde" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label36" runat="server" Text="Fecha Hasta" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TxbFechaIni" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TxbFechaIni"
                                                            Format="dd-MM-yyyy"></asp:CalendarExtender>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TxbFechaFin" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="TxbFechaFin"
                                                            Format="dd-MM-yyyy"></asp:CalendarExtender>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td>
                                <table id="TblEstado" runat="server" >
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label37" runat="server" Text="Estado" Font-Names="Calibri"
                                                Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="DDLEstado" runat="server" Font-Names="calibri" Font-Size="Small" AppendDataBoundItems="true"  DataSourceID="SqlDataSourceEstado" DataTextField="Descipcion" DataValueField="IdEstado">
                                                <asp:ListItem Value="0">--Seleccione--</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="SqlDataSourceEstado" runat="server" ConnectionString="<%$ ConnectionStrings:Sherlock_TestConnectionString %>" SelectCommand="select * from dbo.Estado"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr align="center">
                            <td colspan="2">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="Btn_Aceptar" runat="server" Text="Consultar" Font-Names="Calibri" Font-Size="Small" Width="100px" Height="40px" OnClick="Btn_Aceptar_Click" />
                                        </td>
                                        <td>
                                            <asp:Button ID="Btn_Limpiar" runat="server" Text="Limpiar" Font-Names="Calibri" Font-Size="Small" Width="100px" Height="40px" OnClick="Btn_Limpiar_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <tr>
                <td>
                    ...
                    <tr id="TrGvResultados" runat="server" visible="false">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" EnableModelValidation="True"
                                    ...
                                    PageSize="10" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="Id" HeaderText="IdFormulario"/>
                                        <asp:BoundField DataField="IdTipoPersona" HeaderText="IdTipoPersona" Visible="false" />
                                        ...
                                        <asp:BoundField DataField="estadoFormulario" HeaderText="Estado Formulario" />
                                        <asp:BoundField DataField="fechaActualizacion" HeaderText="Fecha Actualizacion" />
            ...
            <tr id="TrGvExportar" runat="server" visible="false" align="center">
                <td>
                    <asp:ImageButton ID="ImgBtnExportar" runat="server" ImageUrl="~/Imagenes/Icons/excel.png" OnClick="ImgBtnExportar_Click" />
                </td>
            </tr>
                    

            <tr runat="server" id="trIframe" align="center" visible="false">
                <td align="center">
                    <br />
                    <iframe runat="server" id="iframeFCC_Validar" style="width: 1200px; height: 1200px; border: none;"></iframe>
                    <div runat="server" id="dvIframe" width="100%" height="100%"></div>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <asp:Button ID="BtnCerrarIFrame" runat="server" Text="Cerrar" Font-Names="Calibri" Font-Size="Small" Width="100px" Height="40px" OnClick="BtnCerrarIFrame_Click" Visible="false"/>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table align="center" bgcolor="#EEEEEE" id="tblOld" runat="server" visible="false">
            <tr align="center" bgcolor="#333399">
                <td>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="DropDownList39" runat="server" Width="105px" AutoPostBack="True"
                                                            OnSelectedIndexChanged="DropDownList39_SelectedIndexChanged"
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <asp:Label ID="Label12" runat="server" Text="Desde" Font-Names="Calibri"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label13" runat="server" Text="Hasta" Font-Names="Calibri"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label11" runat="server" Text="Fecha Deligenciamiento" Font-Names="Calibri"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="FechaDesde" runat="server" ToolTip="DD/MM/AAAA" MaxLength="15" Width="95px"></asp:TextBox>
                                                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="FechaDesde"
                                                            Format="dd-MM-yyyy"></asp:CalendarExtender>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="FechaHasta" runat="server" ToolTip="DD/MM/AAAA" MaxLength="15" Width="95px"></asp:TextBox>
                                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="FechaHasta"
                                                            Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label15" runat="server" Text="Estado" Font-Names="Calibri"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="DDLEstados" runat="server" DataSourceID="SqlDataSource1" DataTextField="Estado" DataValueField="IdEstado" AppendDataBoundItems="true" Width="95px">
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" EnableModelValidation="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FechaAprobado" HeaderText="Fecha Aprobación" />
            ...
            <%--<tr runat="server" id="trIframe" align="center">
                <td align="center">
                    <iframe runat="server" id="iframeFCC_Validar" style="width: 1200px; height: 800px; border: none;"></iframe>
                    <div runat="server" id="dvIframe" width="100%" height="100%"></div>
                </td>
            </tr>--%>

            <tr align="left" id="TrPrincipalFCC" runat="server" visible="false">
                <td>
                    <table id="tbFormulario" runat="server">
                        <tr>
                            <td>
                                <table align="center" width="100%">
                                    <tr>
                                        <td style="font-size: 13px;">
                                            <asp:Label ID="Label2000" runat="server" Text="Tipo de Formulario:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <table border="1px" style="width: 1015px">
                                        ...
                                        <div id="PartesFormulario" visible="true">
                                            <tr id="Encabezado" runat="server" visible="false">
                                                <td>
                                                    <table align="center" width="100%" visible="false">
                                                        <tr align="center">
                                                            <td>
                                                                <asp:Label ID="lblTituloFormulario" runat="server" Text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="center">
                                                            <td>
                                                                <asp:Label ID="lblSubTituloFormulario" runat="server" Text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="center">
                                                            <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:DropDownList ID="DDLcodCIIU" runat="server" DataSourceID="sqlDSPNciiuCod"
                                                                                DataTextField="CIIU" DataValueField="CIIU" AutoPostBack="true" OnSelectedIndexChanged="DDLcodCIIU_SelectedIndexChanged">
                                                            ...
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="tbxPNOcupacionOficio" runat="server" MaxLength="20" Width="150px"></asp:TextBox></td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlTipoActividadPN" runat="server" DataSourceID="sqlDSPNtipoactividad"
                                                                                DataTextField="Nombre" DataValueField="IdTipoActividad" AutoPostBack="true" OnSelectedIndexChanged="ddlTipoActividadPN_SelectedIndexChanged">
                                                                            </asp:DropDownList>
                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="tbxPNOtrosIngresos" runat="server" MaxLength="20" Width="160px" AutoPostBack="True" OnTextChanged="tbxPNOtrosIngresos_TextChanged"></asp:TextBox><asp:FilteredTextBoxExtender ID="ftbPNOtrosIngresos" runat="server"
                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlPNPregunta4" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPNPregunta4_SelectedIndexChanged">
                                                                                <asp:ListItem Value="">---</asp:ListItem>
                                                                                <asp:ListItem Value="SI">SI</asp:ListItem>
                                                                                <asp:ListItem Value="NO">NO</asp:ListItem>
                                                        ...
                                                        <tr runat="server" id="TrVinculoPPExpuestaPN" visible="false">
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="LprimerapellidpPNPPE" runat="server" Text="PRIMER APELLIDO:"></asp:Label></td>
                                                                        <td>
                                                                            <asp:TextBox ID="TXprimerApellidoPNPPE" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="LsegundoApellidoPNPPE" runat="server" Text="SEGUNDO APELLIDO:"></asp:Label></td>
                                                                        <td>
                                                                            <asp:TextBox ID="TXsegundApellidoPNPPE" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="LnombresPNPPE" runat="server" Text="NOMBRES:"></asp:Label></td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="LocupacionPNPPE" runat="server" Text="OCUPACION:"></asp:Label></td>
                                                                        <td>
                                                                            <asp:TextBox ID="TXocupacionPNPPE" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="LcargoPNPPE" runat="server" Text="CARGO:"></asp:Label></td>
                                                                        <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lblPNEspecificacionPreguntas" runat="server" Text="INDIQUE" Visible="false"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="tbxPNEspecificacionPreguntas" runat="server" MaxLength="100" Width="320px" Visible="false"></asp:TextBox><asp:RequiredFieldValidator ID="rfvPNEspecificacionPreguntas" runat="server"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlPJTipoEmpresa" runat="server">
                                                                                ...
                                                                                <asp:ListItem Value="OFICINA">OFICINA DE REPRESENTACION</asp:ListItem>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:DropDownList ID="DDLPJcodCiiu" runat="server" DataSourceID="sqlDSPJciiuCod"
                                                                                DataTextField="CIIU" DataValueField="CIIU" AutoPostBack="true" OnSelectedIndexChanged="DDLPJcodCiiu_SelectedIndexChanged">
                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlPJPregunta4" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPJPregunta4_SelectedIndexChanged">
                                                                                <asp:ListItem Value="">---</asp:ListItem>
                                                                                <asp:ListItem Value="SI">SI</asp:ListItem>
                                                                                <asp:ListItem Value="NO">NO</asp:ListItem>
                                                                            </asp:DropDownList>
                                                        ...
                                                        <tr runat="server" id="TrVinculoPPExpuestaPJ" visible="false">
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="LPrimerApellidoPPE" runat="server" Text="PRIMER APELLIDO:"></asp:Label></td>
                                                                        <td>
                                                                            <asp:TextBox ID="TXprimerApellidoPPE" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="LSegundoApellidPPE" runat="server" Text="SEGUNDO APELLIDO:"></asp:Label></td>
                                                                        <td>
                                                                            <asp:TextBox ID="TXsegundoApellidoPPE" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="LnombresPPE" runat="server" Text="NOMBRES:"></asp:Label></td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="LOcupacionPPE" runat="server" Text="OCUPACION:"></asp:Label></td>
                                                                        <td>
                                                                            <asp:TextBox ID="TXocipacionPPE" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="LcargoPPE" runat="server" Text="CARGO:"></asp:Label></td>
                                                                        <td>
                                                            ...
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="tbxPJEspecificacionPreguntas" runat="server" MaxLength="80" Width="160px"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="rfvEspefificacionP4" runat="server"
                                                                                ControlToValidate="tbxPJEspecificacionPreguntas"
                                                                                ValidationGroup="vdgWillis"
                                                                                ErrorMessage="*"
                                                                                ForeColor="Red">
                                                                            </asp:RequiredFieldValidator>
                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="tbxPJOtrosIngresos" runat="server" Width="160px" MaxLength="100" AutoPostBack="True" OnTextChanged="tbxPJOtrosIngresos_TextChanged"></asp:TextBox>
    ...
    "></asp:Label>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="height: 43px">
                                                                                        <table>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <asp:Label ID="LUsuarioEntrevista" runat="server" Text="Usuario de Registro:"></asp:Label>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <asp:TextBox ID="TXusuarioEntrevista" runat="server" MaxLength="80" Width="166px" Enabled="false"></asp:TextBox>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <asp:Label ID="LfechaRegistroEntrevista" runat="server" Text="Fecha de Registro:"></asp:Label>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <asp:TextBox ID="TXfechaRegistroEntrevista" runat="server" MaxLength="80" Width="166px" Enabled="false"></asp:TextBox>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                    ...
                                                                                    <td class="auto-style6">
                                                                                        <table>
                                                                                            ...
                                                                                            <table>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <asp:Label ID="LusuarioVerificacion" runat="server" Text="Usuario de Registro:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TXusuarioVerificacion" runat="server" MaxLength="80" Width="166px" Enabled="false"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <asp:Label ID="LfechaRegistroVerificacion" runat="server" Text="Fecha de Registro:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TXfechaRegistroVerificacion" runat="server" MaxLength="80" Width="166px" Enabled="false"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table>
                                                                                            ...
                                                                                            <tr align="center">
                                                                                                <td bgcolor="#BBBBBB">
                                                                                                    <asp:Label ID="Label1990" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Adjuntar documento .pdf:"></asp:Label>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <asp:FileUpload ID="FileUpload1" runat="server" Font-Names="Calibri" Font-Size="Small" />
                                                                                                </td>
                                                                                                <td>
                                                                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Imagenes/Icons/Add.png" OnClick="ImageButton1_Click" ToolTip="Adjuntar" />
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                    ...
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <asp:Button ID="Button1" runat="server" Font-Names="Calibri" Font-Size="Small" OnClick="Button1_Click" Text="Modificar" ValidationGroup="vdgWillis" Visible="False" />
                                            </td>
                                            <td>
                                                <asp:Button ID="Button2" runat="server" Font-Names="Calibri" Font-Size="Small" OnClick="Button2_Click" Text="Imprimir" Visible="false" />
                                            </td>
                                            <td>
                                                <asp:Button ID="Button3" runat="server" Font-Names="Calibri" Font-Size="Small" OnClick="Button3_Click" Text="Continuar" Visible="False" />
                                            </td>
                                        </tr>
                                    </table>
                                    <h1></h1>
    ...
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="DDLTipoPersona" />
        <asp:PostBackTrigger ControlID="BtnCerrarIFrame" />
        <asp:PostBackTrigger ControlID="Btn_Aceptar" />
        <asp:PostBackTrigger ControlID="Btn_Limpiar" />
        <asp:PostBackTrigger ControlID="ImgBtnExportar" />
    </Triggers>
</asp:UpdatePanel>
