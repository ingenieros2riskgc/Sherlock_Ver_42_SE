...
<%@ Register Src="~/UserControls/Riesgos/EstadoRiesgo.ascx" TagPrefix="uc1" TagName="EstadoRiesgo" %>
    ...
    <tr>
        <td align="left">
            <table id="TBmenu" runat="server" visible="false">
                <tr>
                    <td class="style2">
                        <asp:Menu ID="Menu3" runat="server" Font-Names="Franklin Gothic Medium"
                                ...
                                <asp:MenuItem Text="Calidad" Value="Calidad">
                                    ...
                                    <asp:MenuItem Text="Gestión Calidad" Value="Calidad">
                                        <asp:MenuItem Text="Auditoría" Value="PromragaAuditoria">
                                            ...
                                            <asp:MenuItem Text="Gestión de ACM" NavigateUrl="~/Formularios/Proceso/Acm/GestionAcm.aspx" Value="Acm"></asp:MenuItem>
                                        </asp:MenuItem>
                                ...
                                <asp:MenuItem Text="Riesgos" Value="Riesgos">
                                    <asp:MenuItem Text="Parametrización" Value="Parametrización">
                                        <asp:MenuItem Text="Eventos" Value="Eventos">
                                            ...
                                            <asp:MenuItem NavigateUrl="~/Formularios/Eventos/Clases.aspx" Text="Clases"
                                            ...
                                            <asp:MenuItem NavigateUrl="~/Formularios/Eventos/ImpactoCualitativo.aspx" Text="Impacto Cualitativo"
                                                Value="Impacto Cualitativo"></asp:MenuItem>
                                        ...
                                        <asp:MenuItem Text="Riesgos" Value="Riesgos">
                                            ...
                                            <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/EstadoRiesgo.aspx" Text="Estados" Value="Estado"></asp:MenuItem>
                                            <%--yoendy--%>
                                            
                                        </asp:MenuItem>
                                        <asp:MenuItem Text="Calificación Cuantitativa" Value="Riesgos">
                                            <asp:MenuItem Text="Frecuencia" Value="FrecuenciaCuantitativa">
                                                <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/CalificacionExpVarCat.aspx" Text="Variables" Value="Variables"></asp:MenuItem>
                                                <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/CalificacionExpCategoria.aspx" Text="Categorías" Value="Categorias"></asp:MenuItem>
                                                <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/CalificacionPuntosdeCorte.aspx" Text="Puntos de Corte" Value="PuntosDeCorte"></asp:MenuItem>
                                            </asp:MenuItem>
                                            <asp:MenuItem Text="Impacto" Value="ImpactoCuantitativa">
                                                <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/CalificacionExpVarImpacto.aspx" Text="Variables" Value="VariablesImpacto"></asp:MenuItem>
                                                <%--<asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/CalificacionExpCategoriaImpacto.aspx" Text="Categorías" Value="Categorias"></asp:MenuItem>
                                                <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/CalificacionPuntosdeCorteImpacto.aspx" Text="Puntos de Corte" Value="PuntosDeCorte"></asp:MenuItem>--%>
                                            </asp:MenuItem>
                                        </asp:MenuItem>
                                    ...
                                    <asp:MenuItem NavigateUrl="~/Formularios/Riesgos/Admin/paRiesgoEvento.aspx" Text="Planes de Accion"
                                        Value="Planes de Accion"></asp:MenuItem>
                                    <%--yoendy--%>
                                    <asp:MenuItem Text="Controles" Value="Controles">
