...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    ...
    <SelectParameters>
        <asp:ControlParameter ControlID="txtCodAuditoriaSel" Name="IdAuditoria" PropertyName="Text"
            Type="Int64" />
        <asp:ControlParameter ControlID="txtCodEnfoqueSel" Name="IdDetalleEnfoque" PropertyName="Text"
            Type="Int64" />
    </SelectParameters>
    <DeleteParameters>
                    ...
                    <table align="center" width="100%">
                        ...
                        <tr id="filaTabGestion" runat="server" bgcolor="#EEEEEE" visible="false" align="center">
                            <td>
                                ...
                                <br />
                                <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4" OnActiveTabChanged="TabContainer1_ActiveTabChanged"
                                    AutoPostBack="True">
