    ...
    public partial class ParEveTipoPerdida : System.Web.UI.UserControl
    {
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    if (Convert.ToBoolean(rbtnEstadoActivo.Checked ? 1 : 0) == false)
                    {
                        int estado = 0;
            ...
            try
            {
                ...
                else
                {
                    if (Convert.ToBoolean(rbtnEstadoActivo.Checked ? 1 : 0) == false)
                    {
                        ...
                        InfoGridTipoPerdida.Rows[RowGridTipoPerdida]["IdTipoPerdidaEvento"].ToString().Trim(), estado);
                        resetValuesCamposTipoPerdida();
                        loadGridTipoPerdida();
                        loadInfoTipoPerdida();
        ...
        private void detalleRegistroTipoPerdida()
        {
            ...
            string idTipoPerdidaEvento = InfoGridTipoPerdida.Rows[RowGridTipoPerdida]["IdTipoPerdidaEvento"].ToString().Trim();
            string estado = cParametrizacionRiesgos.consultaestado(idTipoPerdidaEvento);
            if (estado == "1")
            {
