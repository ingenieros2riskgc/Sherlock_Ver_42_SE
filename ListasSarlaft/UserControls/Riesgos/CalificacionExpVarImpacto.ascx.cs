...
{
    public partial class CalificacionExpVarImpacto : System.Web.UI.UserControl
    {
        ...
        protected void CambiaEstadoVariable_Click(object sender, EventArgs e)
        {
            objVariables.IdVariable = IdVariableGlobal;
        ...
        public bool CargarGrillaVariables()
        {
            ...
            {
                omb.ShowMessage("Error al cargar las variables: " + ex.Message.ToString(), 1, "Error");
            }
