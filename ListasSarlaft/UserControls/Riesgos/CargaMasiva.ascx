...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <table align="center" bgcolor="#EEEEEE">
                                    ...
                                    <tr align="left">
                                        ...
                                        <td bgcolor="#EEEEEE">
                                            <asp:DropDownList ID="DDLopciones" runat="server" Width="250px" Font-Names="Calibri"
                                                ...
                                                <asp:ListItem Value="3">Eventos Creación</asp:ListItem>
                                                <asp:ListItem Value="5">Eventos Datos Complementarios</asp:ListItem>
                                                <asp:ListItem Value="6">Eventos Con Datos Complementarios</asp:ListItem>
            ...
            <tr align="center" runat="server" visible="false" id="TrButtonsExportRiesgos">
                <td>
                    <table id="TbDownload" runat="server">
                        <tr align="center">
                            <td>Para exportar el Excel de Datos Parametricos:
                            </td>
                            <td>
                            ...
                            <td>Para exportar la plantilla de cargue en Excel:
                            </td>
                            <td class="auto-style1">
                                <asp:ImageButton ID="ImButtonExcelExportPlantillaRiesgo" runat="server" ImageUrl="~/Imagenes/Icons/excel.png" OnClick="ImButtonExcelExportPlantillaRiesgo_Click" Width="26px" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr id="TrLoadFile" runat="server" visible="false" align="center">
                <td>
                    <table>
                        ...
                        <tr id="trUploadFilesPlantillas" runat="server" visible="false">
                            <td>
                                <asp:FileUpload ID="FileUpload1" runat="server" Font-Names="Calibri" Font-Size="Small"
                                    Width="400px" />
                            </td>
                            <td>
                                <asp:Button ID="Badd" runat="server" Text="Ingresar" OnClick="Badd_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="DescripcionEvento" runat="server" Text='<%# Server.HtmlDecode(Eval("DescripcionEvento").ToString()) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Left" Width="100%" />
                </asp:TemplateField>
                                        <%--<asp:BoundField HeaderText="Nombre Generador" DataField="NomGeneradorEvento" />--%>
                                        <asp:TemplateField HeaderText="Nombre Generador" SortExpression="Nombre Generador">
                    <ItemTemplate>
                        <asp:Label ID="NomGeneradorEvento" runat="server" Text='<%# Server.HtmlDecode(Eval("NomGeneradorEvento").ToString()) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Left" Width="100%" />
                </asp:TemplateField>
                                    </Columns>
    ...
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="Badd" />
