<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalificacionExpPuntosDeCorte.ascx.cs" Inherits="ListasSarlaft.UserControls.Riesgos.CalificacionExpPuntosDeCorte" %>
                ...
                <tr align="center" bgcolor="#333399">
                    <td>
                        <asp:Label ID="Label140" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                            ForeColor="White" Text="Puntos de Corte - Calificación Experta"></asp:Label>
                    </td>
                </tr>
            </table>
            <table>
