...
<style type="text/css">
    ...
    .ColorEnfoquePequeno {
        border-radius: 200px 200px 200px 200px;
        -moz-border-radius: 200px 200px 200px 200px;
        -webkit-border-radius: 237px 200px 200px 200px;
        border: 1px solid #000000;
        font-size: 5px;
        width: 15px;
        height: 12px;
...
<body>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="DivContenedores" style="display: flex;">
                <asp:Panel runat="server" ID="PanelContenedor" Style="margin-left: 27%;">
                    <table id="TablaContenedora" align="center" bgcolor="#EEEEEE">
                        ...
                        <tr id="trMapaRiesgos" runat="server" visible="false">
                            <td style="display: -webkit-box;">
                                ...
                                <asp:Panel runat="server" ID="PanelLeyenda" Visible="false">
                                    <table id="ContieneLeyenda" style="margin-top: 13px; margin-left: 10px;">
                                        <tr align="center">
                                            <td>
                                                <asp:GridView ID="GvLeyenda" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField HeaderText="Id" DataField="IdClasificacionRiesgo" Visible="false" />
                                                        ...
                                                        <asp:BoundField HeaderText="Nombre Clasificación" DataField="NombreClasificacionRiesgo" />
                                                    </Columns>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox CssClass="Extremo" runat="server" Width="30px" ReadOnly="true" ToolTip="Extremo" Font-Size="Small" Style="margin-left: 17px;"></asp:TextBox>
                                                <asp:Label ID="Label19" runat="server" Text="Extremo"></asp:Label>
                                                <asp:TextBox CssClass="Alto" runat="server" Width="30px" ReadOnly="true" ToolTip="Alto" Font-Size="Small" Style="margin-left: 9px;"></asp:TextBox>
                                                <asp:Label ID="Label20" runat="server" Text="Alto"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: -webkit-center;">
                                                <asp:TextBox CssClass="Moderado" runat="server" Width="30px" ReadOnly="true" ToolTip="Moderado" Font-Size="Small"></asp:TextBox>
                                                <asp:Label ID="Label21" runat="server" Text="Moderado"></asp:Label>
                                                <asp:TextBox CssClass="Raro" runat="server" Width="30px" ReadOnly="true" ToolTip="Raro" Font-Size="Small"></asp:TextBox>
                                                <asp:Label ID="Label22" runat="server" Text="Bajo"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
        ...
        <Triggers>
            <%--<asp:PostBackTrigger  ControlID="Panel51" />  --%>
        </Triggers>
    </asp:UpdatePanel>
</body>
</html>
