...
{
    public partial class CalificacionExpCategoria : System.Web.UI.UserControl
    {
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            {
                omb.ShowMessage("Error al actualizar: " + ex.Message.ToString() , 1 , "Error");               
            }                    
        }
        #endregion Eventos
        ...
        public void ComboNombresVariables()
        {
            try
            {
                ...
                {
                    omb.ShowMessage("No existen varables ni categorías cargadas, se sugiere cargar primero las variables.", 2 , "Atención");
                }
            }
            catch (Exception ex)
            {
                omb.ShowMessage("Error al cargar las categorias: " + ex.Message.ToString(), 1 , "Error");
            }
